...
brew install npm neovim wget lazygit cmake efm-langserver luarocks rust rust-analyzer golang fzf fd zoxide eza yazi ffmpeg sevenzip jq poppler ripgrep imagemagick font-symbols-only-nerd-font
...
echo 
wget 'https://iterm2.com/downloads/stable/iTerm2-3_5_14.zip'
unzip iTerm2-3_5_14.zip
